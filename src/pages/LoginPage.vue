<template>
  <div class="flex min-h-screen items-center justify-center bg-gray-50">
    <div class="card w-full max-w-md p-8">
      <h1 class="mb-4 text-center align-bottom text-xl font-bold">
      ...
      <div
        v-if="isLoading"
        class="mb-4 rounded border border-blue-200 bg-blue-50 p-3 text-center text-sm text-blue-700"
      >
        Authenticating...
      </div>
      ...
      <form @submit.prevent="handleLogin">
        ...
        <button class="btn btn-primary mt-4 w-full" type="submit" :disabled="isLoading">
